...
#
# https://hub.docker.com/r/southworks/ffmpeg-custom/
#
#
...
ENV         FFMPEG_VERSION=custom-3.4.2 \
...
RUN  \
        DIR=$(mktemp -d) && cd ${DIR} && \
        curl -sL https://github.com/southworkscom/FFmpeg/archive/${FFMPEG_VERSION}.tar.gz | tar zxvf - -C . && \
